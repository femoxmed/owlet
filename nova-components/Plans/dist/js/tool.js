    ...
    methods: {
        addPlan: function addPlan() {
            ...
            axios.post("/api/create-plan", {
                ...
                __WEBPACK_IMPORTED_MODULE_0_sweetalert___default()("New Condition", "New Condition created successfully", "success");
                // window.location.href = "/admin";
                // console.log(res.data);
            }).catch(function (err) {
                console.error(err);
                __WEBPACK_IMPORTED_MODULE_0_sweetalert___default()("Error", "There was an error submitting the form", "error");
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Plan s")]),
      _vm._v(" "),
      _vm._m(0),
      _vm._v(" "),
      _c("div", { staticClass: "card" }, [
        _vm.errors
          ? _c(
              ...
              {
                staticClass:
                  "bg-red-500 text-dark py-2 px-4 pr-0 rounded font-bold mb-4 shadow-lg"
              },
              _vm._l(_vm.errors, function(v, k) {
                return _c(
                  ...
                  _vm._l(v, function(error) {
                    return _c(
                      "p",
                      { key: error, staticClass: "text-sm text-danger" },
                      [
                        _vm._v(
                          "\n                    " +
                            _vm._s(error) +
          ...
          _c("div", { staticClass: "py-6 px-8 w-1/2" }, [
            _c(
              ...
              [
                ...
                _vm._v(" "),
                _c("option", { attrs: { value: "biannually" } }, [
                  _vm._v("biannually")
                ]),
                _vm._v(" "),
        ...
        _vm._v(" "),
        _c("div", { staticClass: "flex items-center py-6 mr-5" }, [
          _c("a", {
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("2950a532", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5bd01d73\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Table.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5bd01d73\",\"scoped\":false,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Table.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getConditions: function getConditions() {
            ...
            axios.get("/api/plans").then(function (res) {
                _this.conditions = res.data;
                console.log(res.data);
            }).catch(function (err) {
                console.error(err);
            });
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Conditions")]),
      _vm._v(" "),
      _vm._m(0),
      _vm._v(" "),
      _c("div", { staticClass: "card" }, [
        _vm.errors
          ? _c(
              ...
              _vm._l(_vm.conditions, function(v, k) {
                return _c(
                  "div",
                  { key: k },
                  _vm._l(v, function(error) {
                      ...
                      _c("div", { staticClass: "text-left text-left" }, [
                        _c(
                          "a",
                          {
                            ...
                            attrs: { href: "/admin/resources/users/1" }
                          },
                          [
                            _vm._v(
                              "\n                                    " +
...
var staticRenderFns = [
      ...
      _c("div", { staticClass: "w-full flex items-center mb-6" }, [
        ...
        _c("div", { staticClass: "flex-no-shrink ml-auto" }, [
          _c(
            ...
            {
              staticClass: "btn btn-default btn-primary",
              attrs: { href: "/plans/create", dusk: "create-button" }
            },
            [_vm._v("\n                    Create Plans\n                ")]
          )
        ])
  ...
  function() {
    ...
    return _c(
      "td",
      { staticClass: "w-16", attrs: { "data-children-count": "1" } },
      [
        _c("input", {
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("td", { staticClass: "td-fit text-right pr-6 align-middle" }, [
